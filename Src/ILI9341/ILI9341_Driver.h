...
#define  RESET_OFF 		HAL_GPIO_WritePin(GPIOB,RESET_Pin,GPIO_PIN_SET)
#define  RESET_ON 		HAL_GPIO_WritePin(GPIOB,RESET_Pin,GPIO_PIN_RESET)
#define  CS_OFF 		HAL_GPIO_WritePin(GPIOB,CS_Pin,GPIO_PIN_SET)
#define  CS_ON 			HAL_GPIO_WritePin(GPIOB,CS_Pin,GPIO_PIN_RESET)
#define  DC_DATA 		HAL_GPIO_WritePin(GPIOB,DC_Pin,GPIO_PIN_SET)
#define  DC_COMMAND 	HAL_GPIO_WritePin(GPIOB,DC_Pin,GPIO_PIN_RESET)
